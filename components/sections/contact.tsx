  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Phone",
      content: "+254 745-456-723",
      link: "tel:+254759096082",
    },
    {
      icon: Mail,
      title: "Email",
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="flooring">Epoxy Flooring</option>
                    <option value="countertop">Epoxy Countertop</option>
                    <option value="table">Epoxy Table</option>
                    <option value="art">Custom Resin Art</option>
